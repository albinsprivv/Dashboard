                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span><img src="<?php echo url('/'); ?>/global/img/flags/de.png"></img> Amazon.de</span>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"><img src="<?php echo url('/'); ?>/global/img/flags/de.png"></img><strong> Amazon</strong>
                            <small>Generate invoices for Amazon.de</small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <button type="button" id="prefillBtn" class="btn btn-success mt-ladda-btn ladda-button" data-style="zoom-out">
                                                 ...
                                                 <br /><br />
                                @endif
                                <form action="<?php echo url('/');?>/generator/amazon/de/invoice" method="POST">
                                   {{ csrf_field() }}
