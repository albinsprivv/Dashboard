                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span><img src="<?php echo url('/'); ?>/global/img/flags/gb.png"></img> Amazon.co.uk</span>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"><img src="<?php echo url('/'); ?>/global/img/flags/gb.png"></img><strong> Amazon</strong>
                            <small>Generate invoices for Amazon.co.uk</small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <button type="button" id="prefillBtn" class="btn btn-success mt-ladda-btn ladda-button" data-style="zoom-out">
                                                 ...
                                                 <br /><br />
                                @endif
                                <form action="<?php echo url('/');?>/generator/amazon/uk/invoice" method="POST">
                                   {{ csrf_field() }}
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="input-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="State" name="region" required>
                                     </div>
                                   </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="input-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="Item Name" name="product" required>
                                     </div>
                                   </div>
                                   <div class="form-group">
                                     <label>Order #:</label>
                                     <div class="input-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="Order Number" name="order" id="ordernumber" required>
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="input-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="Shipping Cost" name="shippingprice" required>
                                     </div>
                                   </div>
                                   <div class="form-group">
                                     <label>Seller:</label>
                                     <div class="input-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="Seller" name="soldby" required>
                                     </div>
                                   </div>
